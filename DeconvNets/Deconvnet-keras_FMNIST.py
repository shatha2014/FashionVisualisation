...
def argparser():
    ...
    parser.add_argument('--model' , action ='store', dest = 'model_path',
                        ...
                        help = 'Path of CNN model. If no flag is given, then VGG16 model is used.')
    return parser
...
def main():
    ...
    #img = Image.fromarray(uint8_deconv, 'LA')
    img = Image.fromarray(deconv, 'LA')
